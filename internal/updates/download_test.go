...
func TestStreamInstallerQuietOnCompleteCopy(t *testing.T) {
	...
	streamInstaller(w, r, strings.NewReader(body), updaterclient.ProductEMLy, "2.2.2", "EMLy_2.2.2.exe", int64(len(body)))
...
func TestStreamInstallerWarnsOnServerTimeout(t *testing.T) {
	...
	streamInstaller(w, r, &shortReader{left: 4096, err: context.DeadlineExceeded},
		updaterclient.ProductEMLy, "2.2.2", "EMLy_2.2.2.exe", 50_000_000)
	...
	if a["version"] != "2.2.2" || a["product"] != updaterclient.ProductEMLy {
...
func TestStreamInstallerWarnsOnClientDisconnect(t *testing.T) {
	...
	streamInstaller(w, r, &shortReader{left: 10, err: io.ErrUnexpectedEOF},
		updaterclient.ProductUpdater, "1.6.2", "EMLyUpdater_Installer_1.6.2.exe", 1000)
...
func TestStreamInstallerWarnsOnShortBodyWithoutError(t *testing.T) {
	...
	streamInstaller(w, r, strings.NewReader("partial"), updaterclient.ProductEMLy, "2.2.2", "EMLy_2.2.2.exe", 900)
